...
class Director:
    ...
    def _process(self):
        ...
        #gets the input of the letters you want to guess on
        self._user_guess = input("Guess a letter [a-z]: ")

        #Process the input into the output
        #Replacing the dash in the blank word which is the length of the random word with the correct letters
